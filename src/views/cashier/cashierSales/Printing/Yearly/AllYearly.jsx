...
const YearlySale = React.forwardRef(({ sales, cinfo, user }, ref) => {
  return (
    <div
      className="w-100 p-2"
      ref={ref}
    ...
    >
      ...
      <h4 className="text-left mt-1">Yearly Sale Information</h4>
      <hr />
      {sales
        ? Array.isArray(sales)
          ? sales.map((data) => {
                    ...
                    return (
                      <>
                        <table className="table">
                          ...
                          <tbody>
                            <tr className="mt-1">
                              <th className="text-left"> {dData.date} </th>
                        ...
                        {dData.data.map((dateData) => {
                          return (
                            <>
                              <h3>
                                Date:{" "}
                                <span
                                  style={{ letterSpacing: 2, color: "#5c5c5c" }}
                                >
                                  {" "}
                                  {dateData.date}{" "}
                                </span>
